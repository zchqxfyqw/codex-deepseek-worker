...
- Let the Worker inspect Git read-only, but never stage, commit, push, or alter the index, HEAD, refs, or shared worktree metadata. Leave Git integration to the main Codex.
