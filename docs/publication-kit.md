...
- Default branch: `main`
- License: MIT
- Current release tag: `v0.2.4-rc1`
...
> Codex DeepSeek Worker v0.2.4-rc1 — bounded result parsing candidate
...
- [ ] Push `main`, confirm private vulnerability reporting, and create `v0.2.4-rc1` only after explicit approval.
...
gh release create v0.2.4-rc1 --prerelease --title "Codex DeepSeek Worker v0.2.4-rc1 — bounded result parsing candidate" --notes-file RELEASE_NOTES.md
```
